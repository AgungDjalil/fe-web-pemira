        ...
        <div className="p-4 sm:ml-64">
            <form className="max-w-md" onSubmit={handleSubmit}>
                ...
                <div className="my-4">
                    ...
                    <textarea id="visi" onChange={e => setVisi(e.target.value)} rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="tulis visi calon..." required></textarea>
                </div>
                <div className="mb-4">
                    <label htmlFor="misi" className="block mb-2 text-sm font-light">Misi Paslon</label>
                    <textarea id="misi" onChange={e => setMisi(e.target.value)} rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="tulis Misi calon..." required></textarea>
                </div>
